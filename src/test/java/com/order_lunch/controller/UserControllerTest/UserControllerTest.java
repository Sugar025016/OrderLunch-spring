...
public class UserControllerTest {
        ...
        void testGetUser_Success() throws Exception {
                ...
                MvcResult validRequestResult = mockMvc.perform(MockMvcRequestBuilders.get("/user")
                                ...
                                .andExpect(jsonPath("$.cartShopId").value(1))
                                .andExpect(jsonPath("$.cartCount").value(8))
                                .andExpect(jsonPath("$.cartLat").value(22.9893802))
                                .andExpect(jsonPath("$.cartLng").value(120.218628))
                                .andExpect(jsonPath("$.cartDeliveryKm").value(10.1))
                                .andExpect(jsonPath("$.orderCount").value(41))
                                .andExpect(jsonPath("$.shopOrderCount").value(1))
